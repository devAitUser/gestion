                  ...
                  <div class="col-md-12">
                      <div class="card">
                          <div class="card-header  gradient-purple-indigo  0-hidden pb-80">
                             <div class="pt-4">
                              <div class="row">
                                  <h4 class="col-md-4 text-white">factures</h4>
                                          ...
                                          <div class="card">
                                             ...
                                             <v-card>
                                                ...
                                                <v-card-title class="text-right">
                                                    ...
                                                    <a href="{{url('facture/create')}}"  class="btn btn-primary btn-md m-1 text-white "><i class="nav-icon i-Shopping-Basket"></i>    Nouveau  </a>
                                                ...
                                                <v-data-table  @input="item($event)" :headers="headers" :items="devis" :search="search" :value="selectedRows" v-model="selected" :items-per-page="5"  :sort-by.sync="sortBy"
...
@section('page-js')
            ...
            <script src="{{ asset('js/app_devis.js') }}"></script>
