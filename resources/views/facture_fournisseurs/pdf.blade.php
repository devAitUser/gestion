...
<body>
  ...
  <table width="100%"  >
    ...
    <tr>
        ...
        <td align="CENTER">
            <h3 class='under_line'>Facture N {{ $devis['id'] }}/{{ $devis['date'] }}</h3>
  ...
  <table class="table_title" width="100%" style='padding-top: 20px; '>
    <tr>
        <td><strong class='under_line'>Etat de paiement&nbsp;:</strong> {{ $devis['objet'] }}</td>

    </tr>
    <tr style='padding-top: 10px;'>

        <td><strong class='under_line'>Fournisseur :</strong> {{ $devis['client'] }} </td>
    </tr>
  ...
  <table width="100%" class='table_info'>
    <thead style="background-color: #e9df85;">
      <tr>
        ...
        <th colspan="2">PRIX TOTAL EN CHIFFRES</th>
      </tr>
    </thead>
    <tbody>
      ...
      <td  colspan="1" class='col_price' align="CENTER" ><div class='c_f' width="50%" align="right">{{ number_format($item->prix,2,",",".")  }}</div></td>
      <td colspan="2" class='col_price' align="right" ><div class='c_f' width="50%" align="right" style='font-weight: bold;'>{{ number_format($item->prix_total,2,",",".")  }}</div></td>
      </tr>
      @endforeach
