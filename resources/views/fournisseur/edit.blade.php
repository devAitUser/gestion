...
<form action="{{url('updatefournisseurs/'.$fournisseur['id'])}}" method="post">
  @csrf
   ...
   <div class="card mt-3">
            ...
            <div class="col-md-10">
               <div class="form-row">
                  <div class="form-group col-md-12">
                     ...
                     <input id="designation" type="text"  name="nom" class="form-control  " value="{{ $fournisseur['nom'] }}" required >
            ...
            <div class="col-md-10">
               <div class="form-row">
                  <div class="form-group col-md-12">
                     ...
                     <input id="designation" type="text"  name="personne_contact" class="form-control  " value="{{ $fournisseur['personne_contact'] }}" required>
                     <div class="invalid-feedback"> Veuillez choisir le Titre de designation.</div>
            ...
            <div class="col-md-10">
               <div class="form-row">
                  <div class="form-group col-md-12">
                     ...
                     <input id="designation" type="email"  name="email" class="form-control  " value="{{ $fournisseur['email'] }}" required>
                     <div class="invalid-feedback"> Veuillez choisir le Titre de designation.</div>
            ...
            <div class="col-md-10">
               <div class="form-row">
                  <div class="form-group col-md-12">
                     ...
                     <input id="designation" type="text"  name="ice" class="form-control  " value="{{ $fournisseur['ice'] }}" required>
                     <div class="invalid-feedback"> Veuillez choisir le Titre de designation.</div>
      ...
      <!-- end::form 3-->
               ...
               <div class="col-md-10">
                  <div class="form-row">
                     <div class="form-group col-md-12">
                        ...
                        <input id="designation" type="text"  name="rib" class="form-control  " value="{{ $fournisseur['rib'] }}" required>
                        <div class="invalid-feedback"> Veuillez choisir le Titre de designation.</div>
               ...
               <div class="col-md-10">
                  <div class="form-row">
                     <div class="form-group col-md-12">
                        ...
                        <input id="designation" type="text"  name="adresse" class="form-control  " value="{{ $fournisseur['adresse'] }}" required>
                        <div class="invalid-feedback"> Veuillez choisir le Titre de designation.</div>
         ...
         <!-- end::form 3-->
               ...
               <div class="card-body">
                  <div class="row">
                     <div class="col-md-2"> <label for="name" class="product-label text-dark"> specialite </label></div>
                     <div class="col-md-10">
                        <div class="form-row">
                           <div class="form-group col-md-12">
                              <label for="inputtext11" class="ul-form__label"> specialite    *</label>
                              <input id="designation" type="text"  name="specialite" class="form-control  " value="{{ $fournisseur['specialite'] }}" required>
                              <div class="invalid-feedback"> Veuillez choisir le Titre de designation.</div>
                     ...
                     <div class="col-md-10">
                        <div class="form-row">
                           <div class="form-group col-md-12">
                              ...
                              <input id="designation" type="text"  name="telephone" class="form-control  " value="{{ $fournisseur['telephone'] }}" required>
                              <div class="invalid-feedback"> Veuillez choisir le Titre de designation.</div>
                     ...
                     <div class="col-md-10">
                        <div class="form-row">
                           <div class="form-group col-md-12">
                              ...
                              <input id="designation" type="text"  name="type" class="form-control  " value="{{ $fournisseur['type'] }}" required>
                              <div class="invalid-feedback"> Veuillez choisir le Titre de designation.</div>
