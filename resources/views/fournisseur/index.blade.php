...
@section('main-content')
           ...
           <div class="breadcrumb">
            ...
            <div id="app_fournisseur" data-app>
                  ...
                  <div class="col-md-12">
                      <div class="card">
                          <div class="card-header  gradient-purple-indigo  0-hidden pb-80">
                             <div class="pt-4">
                              <div class="row">
                                  <h4 class="col-md-4 text-white">fournisseurs</h4>
                          ...
                          <div class="card-body">
                              <div class="ul-contact-list-body">
                                  <div class="ul-contact-main-content">
                                          ...
                                          <div class="card">
                                             ...
                                             <v-card>
                                                ...
                                                <v-card-title class="text-right">
                                                    ...
                                                    <a href="{{url('fournisseur/create')}}"  class="btn btn-primary btn-md m-1 text-white "><i class="nav-icon i-Shopping-Basket"></i>    Nouveau  </a>
                                                ...
                                                <v-data-table  @input="item($event)" :headers="headers" :items="fournisseur" :search="search" :value="selectedRows" v-model="selected" :items-per-page="5"  :sort-by.sync="sortBy"
                                    ...
                                    <template v-slot:item.f_fourniseur="{ item }">
                                        <v-btn color="purple" fab small dark  @click="facture_fournisseur(item)">
                                            <i class="nav-icon i-Folder-Organizing font-weight-bold"></i>
                                         </v-btn>
                                    </template>
...
@section('page-js')
            ...
            <script src="{{ asset('js/app_fornisseur.js') }}"></script>
