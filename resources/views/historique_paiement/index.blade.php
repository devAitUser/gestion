                                          ...
                                          <div class="card">
                                             ...
                                             <v-card>
                                                ...
                                                <v-card-title class="text-right">
                                                    ...
                                                    <a href="{{url('/paiements/create/'.$id)}}"  class="btn btn-primary btn-md m-1 text-white "><i class="nav-icon i-Shopping-Basket"></i>    Nouveau  </a>
                                                ...
                                                <v-data-table  @input="item($event)" :headers="headers" :items="paiements" :search="search" :value="selectedRows" v-model="selected" :items-per-page="5"  :sort-by.sync="sortBy"
